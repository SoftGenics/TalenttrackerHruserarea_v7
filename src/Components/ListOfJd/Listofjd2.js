  ...
  return (
    ...
    <Sidebar />
        ...
        <Container className='jd-list'>
            ...
            <p className='mt-2'>No of jd (3)</p><span className='mx-3 mt-2 fw-bold'>|</span>
         ...
         <Link to="/People"><Button variant='danger' className='mx-3' ><i className="fas fa-filter me-2"style={{color:'#fff'}} ></i>Filter</Button></Link>
            ...
            <Container  className='table-data' fluid>
                <Table responsive className='data-table'>
                    ...
                    <tbody>
                        <tr>
                            <td ><Button variant='warning' className='me-2'>open</Button><small>(not accepted by any user)</small></td>
                            <td>1</td>
                            
                            <td>11/05/22</td>
                            <td className='position'>Client Name<br></br> <span > <OverlayTrigger placement='bottom' overlay={<Tooltip id="tooltip-disabled">Industry</Tooltip>}><i className="fas fa-building me-2"  onClick={handleShow}></i></OverlayTrigger> | <i className="fas fa-user ms-2" onClick={handleShow}></i> </span></td>
                            <td>jd details</td>
                        ...
                        <tr>
                            <td><Button variant='danger' className='me-2'>Pending delivery</Button></td>
                            <td>2</td>
                            
                            <td>11/05/22</td>
                            <td className='position'>Client Name 1<br></br> <span > <i className="fas fa-building me-2"  onClick={handleShow}></i> | <i className="fas fa-user ms-2" onClick={handleShow}></i> </span></td>
                            <td>jd details</td>
                            <td>Special Comments/Remarks</td>
                            <td className='jd-terms'><br></br><i className="fas fa-info-circle" onClick={handleShow4}></i></td>
                            <td className='deatail'>Jd Name <br></br><span><a href='https://talenttrackerhr.in/'><i className="fab fa-firefox me-2"></i></a> | <a href='https://www.linkedin.com/login'><i className="fab fa-linkedin ms-2 me-2"></i></a> | </span> <i className="fas fa-eye ms-2"  onClick={handleShow1}></i></td>
                        ...
                        <tr>
                        <td ><Button style={{backgroundColor:'cyan', color:'black', border:'none'}}>Delivery done-await client feedback</Button></td>
                            <td>3</td>
                            
                            <td>11/05/22</td>
                            <td className='position'>Client Name 3<br></br> <span > <i className="fas fa-building me-2"  onClick={handleShow}></i> | <i className="fas fa-user ms-2" onClick={handleShow}></i> </span></td>
                            <td>jd details</td>
                            <td>Special Comments/Remarks</td>
                            <td className='jd-terms'><br></br><i className="fas fa-info-circle" onClick={handleShow4}></i></td>
                            <td className='deatail'>Jd Name <br></br><span><a href='https://talenttrackerhr.in/'><i className="fab fa-firefox me-2"></i></a> | <a href='https://www.linkedin.com/login'><i className="fab fa-linkedin ms-2 me-2"></i></a> | </span> <i className="fas fa-eye ms-2"  onClick={handleShow1}></i></td>
                        ...
                        <tr>
                        <td ><Button variant='secondary'>Interview stage</Button></td>
                            <td>4</td>
                            
                            <td>11/05/22</td>
                            <td className='position'>Client Name 4<br></br> <span > <i className="fas fa-building me-2"  onClick={handleShow}></i> | <i className="fas fa-user ms-2" onClick={handleShow}></i> </span></td>
                            <td>jd details</td>
                            <td>Special Comments/Remarks</td>
                            <td className='jd-terms'><br></br><i className="fas fa-info-circle" onClick={handleShow4}></i></td>
                            <td className='deatail'>Jd Name <br></br><span><a href='https://talenttrackerhr.in/'><i className="fab fa-firefox me-2"></i></a> | <a href='https://www.linkedin.com/login'><i className="fab fa-linkedin ms-2 me-2"></i></a> | </span> <i className="fas fa-eye ms-2"  onClick={handleShow1}></i></td>
                        ...
                        <tr>
                        <td ><Button variant='success'>Offer stage</Button></td>
                            <td>5</td>
                            
                            <td>11/05/22</td>
                            <td className='position'>Client Name 5<br></br> <span > <i className="fas fa-building me-2"  onClick={handleShow}></i> | <i className="fas fa-user ms-2" onClick={handleShow}></i> </span></td>
                            <td>jd details</td>
                            <td>Special Comments/Remarks</td>
                            <td className='jd-terms'><br></br><i className="fas fa-info-circle" onClick={handleShow4}></i></td>
                            <td className='deatail'>Jd Name <br></br><span><a href='https://talenttrackerhr.in/'><i className="fab fa-firefox me-2"></i></a> | <a href='https://www.linkedin.com/login'><i className="fab fa-linkedin ms-2 me-2"></i></a> | </span> <i className="fas fa-eye ms-2"  onClick={handleShow1}></i></td>
                        ...
                        <tr>
                        <td ><Button style={{backgroundColor:'pink', color:'black', border:'none'}}>JD successfully closed</Button></td>
                            <td>6</td>
                            
                            <td>11/05/22</td>
                            <td className='position'>Client Name 6<br></br> <span > <i className="fas fa-building me-2"  onClick={handleShow}></i> | <i className="fas fa-user ms-2" onClick={handleShow}></i> </span></td>
                            <td>jd details</td>
                            <td>Special Comments/Remarks</td>
                            <td className='jd-terms'><br></br><i className="fas fa-info-circle" onClick={handleShow4}></i></td>
                            <td className='deatail'>Jd Name <br></br><span><a href='https://talenttrackerhr.in/'><i className="fab fa-firefox me-2"></i></a> | <a href='https://www.linkedin.com/login'><i className="fab fa-linkedin ms-2 me-2"></i></a> | </span> <i className="fas fa-eye ms-2"  onClick={handleShow1}></i></td>
                        ...
                        <tr>
                        <td ><Button >Open-Rework</Button><br></br>Client changed the JD criteria</td>
                            <td>7</td>
                            
                            <td>11/05/22</td>
                            <td className='position'>Client Name 7<br></br> <span > <i className="fas fa-building me-2"  onClick={handleShow}></i> | <i className="fas fa-user ms-2" onClick={handleShow}></i> </span></td>
                            <td>jd details</td>
                            <td>Special Comments/Remarks</td>
                            <td className='jd-terms'><br></br><i className="fas fa-info-circle" onClick={handleShow4}></i></td>
                            <td className='deatail'>Jd Name <br></br><span><a href='https://talenttrackerhr.in/'><i className="fab fa-firefox me-2"></i></a> | <a href='https://www.linkedin.com/login'><i className="fab fa-linkedin ms-2 me-2"></i></a> | </span> <i className="fas fa-eye ms-2"  onClick={handleShow1}></i></td>
